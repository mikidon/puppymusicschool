...
<main>
	<section id="content">
		...
		<section id="sec1" class="mt120 sm-mt70">
			<div class="pb70 cols-wide bg-dots ta-c">
				<div class="mt-40 md-mt-25 sm-mt-15 d-ib view view-slideup">
					<h2 class="ff-mi fz300 md-fz250 sm-fz200 lh160">パピーの特徴</h2>
					<p class="ff-en fz130">feature</p>
					<img loading="lazy" src="<?php echo home_url(); ?>/img/base/ic-dot.png" width="20" height="5" class="img-rspsv" alt="dot">
				</div>
				<div class="cols gutter-70 gutter-md-40 ta-l">
					<div class="col-6 col-sm-12 mt40 view view-slideup">
						<figure><img loading="lazy" src="<?php echo home_url(); ?>/img/about/sec1-img1.jpg" width="449" height="240" class="img-rspsv" alt="未経験の方にも丁寧に一からレッスンいたします。"></figure>
						<p class="mt40 bb-black d-ib fz130 md-fz120 pb5">未経験の方にも丁寧に</p>
						<p class="mt15 bb-black d-ib fz130 md-fz120 pb5">一からレッスンいたします。</p>
					...
					<div class="col-6 col-sm-12 mt40 view view-slideup">
						<figure><img loading="lazy" src="<?php echo home_url(); ?>/img/about/sec1-img2.jpg" width="449" height="240" class="img-rspsv" alt="講師の質に、違いあり。生徒さんに寄り添った熱心な指導が特徴です。"></figure>
					...
					<div class="col-6 col-sm-12 mt60 sm-mt40 view view-slideup">
						<figure><img loading="lazy" src="<?php echo home_url(); ?>/img/about/sec1-img3.jpg" width="449" height="240" class="img-rspsv" alt="月謝はうれしい低料金"></figure>
					...
					<div class="col-6 col-sm-12 mt60 sm-mt40 view view-slideup">
						<figure><img loading="lazy" src="<?php echo home_url(); ?>/img/about/sec1-img4.jpg" width="449" height="240" class="img-rspsv" alt="安心の振替制度・充実のイベント"></figure>
		...
		<!-- #sec2 -->
		<div id="sec2" class="mt100 md-mt70 cols sm-jc-fe gutter-sm-40 pb130 md-pb100 sm-pb80">
			...
			<div class="col-5 col-sm-12 return-1 sm-mt-30 view view-slideup">
				<figure class="ta-r"><img loading="lazy" src="<?php echo home_url(); ?>/img/about/sec2-img1.png" width="199" height="192" class="img-rspsv" alt="なぜ、パピーが選ばれるの？"></figure>
				<figure class="sm-ta-l mt40 sm-mt20 sm-pr90"><img loading="lazy" src="<?php echo home_url(); ?>/img/about/sec2-img2.png" width="363" height="368" class="img-rspsv" alt="なぜ、パピーが選ばれるの？"></figure>
			</div>
		</div>
