		...
		<div class="bgc-white pt100 sm-pt50">
			...
			<div class="cols">
				<div class="col-4 col-sm-12">
					<a href="#sec1" class="d-b btn-anchor fw-b hov bd-black ptb15 plr30">音楽祭</a>
				</div>
				<div class="col-4 col-sm-12 sm-mt10">
					<a href="#sec2" class="d-b btn-anchor fw-b hov bd-black ptb15 plr30">グレードテスト</a>
				</div>
				<div class="col-4 col-sm-12 sm-mt10">
					<a href="#sec3" class="d-b btn-anchor fw-b hov bd-black ptb15 plr30">その他のイベント</a>
				</div>
			</div>
				...
				<div class="cols gutter-40">
					<div class="col-12 ta-c view view-slideup">
						<div class="mt-70 md-mt-60 sm-mt-50 d-ib">
							<p class="ff-en fz350 lh180">music festival</p>
							<h2>音楽祭</h2>
							<img loading="lazy" src="<?php echo home_url(); ?>/img/base/ic-dot.png" width="20" height="5" class="img-rspsv" alt="dot">
						</div>
					</div>
					<div class="col-12 ta-c sm-ta-l mt50 sm-mt30 view view-slideup">
				...
				<div class="cols gutter-40">
					...
					<section class="col-12 view view-slideup">
						<div class="mt80 md-mt50 bgc-gray bd-blue ptb60 plr60 md-ptb50 md-plr40 sm-ptb50 sm-plr30 bdrs15">
							...
							<section class="bb-blue mt40 pb40 md-mt30 md-pb30">
								<h4 class="c-blue fz120 sm-fz110">14級～7級（初級・中級）</h4>
								<p class="mt10">学習成果と目標を段階的に確認し、達成感を味わうことで学習意欲向上へとつなげていきます。初級ではポピュラー楽曲なども取り入れ、堅苦しくない親しみやすい選曲となっています。</p>
							</section>
							<section class="bb-blue mt40 pb40 md-mt30 md-pb30">
								<h4 class="c-blue fz120 sm-fz110">6級以上（上級）</h4>
								<p class="mt10">より専門的なピアノのテクニックを磨いていきます。<br class="sm-d-n">
									「将来ピアノの先生になりたい」などの高い目標を持った方にも最適です。</p>
							</section>
						</div>
					</section>
				</div>
			...
			<!-- #sec3 -->
			<section id="sec3" class="bgc-lightgray bg-nami pb100 mb130 md-mb100 sm-mb80">
				<div class="cols gutter-40 ai-c">
					<div class="col-12 ta-c view view-slideup">
						<div class="mt-70 md-mt-60 sm-mt-50 d-ib">
							<p class="ff-en fz350 lh180">event</p>
							<h2>イベント</h2>
							<img loading="lazy" src="<?php echo home_url(); ?>/img/base/ic-dot.png" width="20" height="5" class="img-rspsv" alt="dot">
						</div>
					</div>
					<div class="col-12 ta-c sm-ta-l mt50 sm-mt30 view view-slideup">
						<p>パピーでは様々なイベントを不定期開催。<br class="sm-d-n">
							それぞれの技量、それぞれのミュージックライフに合わせイベントを選ぶことができます。<br class="sm-d-n">
							下記イベントは一部を除き無料でご参加いただけます。</p>
					</div>
					<section class="col-6 col-sm-12 mt50 view view-slideup">
						<div class="bgc-white p40 md-p30 bdrs15 h-eq">
