	...
	<div id="content">
			...
			<div class="ptb20 sm-ptb30 cols-wide bg-dots">
				<div class="cols jc-c ai-c gutter-70 gutter-md-40">
					<div class="col-6 col-sm-12 view view-slideup">
						...
						<p class="mt30">綺麗な音色と手軽さから人気のフルート。しかし初めての人はなかなか良い音が出ません。勘に頼るのではなく正しい指導の下で練習をし、上達していきましょう。まずは姿勢を正すところから先生と一緒に始めましょう。</p>
					</div>
					<div class="col-6 col-sm-10 sm-mt40 view view-slideup">
						<figure class="view view-bounce"><img loading="lazy" src="<?php echo home_url(); ?>/img/flute/sec1-img1.png" width="455" height="448" class="img-rspsv" alt="フルート"></figure>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="cols gutter-30 gutter-sm-40">
				...
				<section class="col-6 col-sm-12 mt50 view view-slideup">
					<div class="bgc-white p40 md-p30 bdrs15 h-eq">
						<h3 class="fz130 sm-fz120 d-ib bb-black pb5">クラシックフルートコース</h3>
						<p class="mt30">フルートはリードを使わず人の息だけで鳴るのが特徴で、急速なパッセージにも繊細な音色で応えてくれます。まずは、基礎から少しずつ学びながらクラシックの名曲を楽しくマスターしましょう。</p>
					</div>
				</section>
				<section class="col-6 col-sm-12 mt50 sm-mt30 view view-slideup">
					<div class="bgc-white p40 md-p30 bdrs15 h-eq">
						<h3 class="fz130 sm-fz120 d-ib bb-black pb5">ポピュラーフルートコース</h3>
						<p class="mt30">フルートを楽しむ上で必要な演奏力を段階的にバランスよく習得していきます。 クラシックからポピュラー音楽までの幅広いジャンルから選曲されたレパートリーを、ソロやアンサンブルで楽しみながら経験していきましょう。</p>
					</div>
				</section>
			</div>
		</section>
		...
		<section id="sec3" class="mtb100 sm-mtb70">
			...
			<div class="cols gutter-70 gutter-md-40 jc-fe">
				<div class="col-4 col-sm-6 sm-mr20 mt-80 sm-mt-80 z2 view view-slideup">
					<figure class="view view-bounce"><img loading="lazy" src="<?php echo home_url(); ?>/img/flute/sec3-img1.jpg" width="314" height="290" class="img-rspsv" alt="レッスン内容例"></figure>
				</div>
				<div class="col-9 col-sm-12 return-1 return-sm-0 mt50 sm-mt-20 z1 view view-slideup">
					<div class="bg-dots bd-blue ptb60 pl80 pr60 sm-ptb40 sm-pl30 sm-pr30 bdrs15">
						<section>
							...
							<p class="mt25">発音しやすい音や動かしやすい指使いの音から始め、曲を使いながらタンギング、スラー等を学びしっかりした音が出せることを目指します。 リズムや強弱、アーティキュレーションについても段階的に導入し豊かな表現力を身につけます。</p>
						</section>
						<section class="mt30">
							<h3 class="c-white ff-sofia bgc-blue d-ib bdrs5 ptb5 plr20">STEP 02</h3>
							<p class="mt25">全音域の音階の習得と正しい指使いでブリチアルディ・キー、スタッカート、マイナースケール等を学び 、レパートリーを増やしながら基礎を仕上げていきます。 ポピュラー音楽の代表的なリズムスタイルや特有のフレーズを体験することにより、ハーモニー感覚も学べます。</p>
						</section>
						<section class="mt30">
							<h3 class="c-white ff-sofia bgc-blue d-ib bdrs5 ptb5 plr20">STEP 03</h3>
							<p class="mt25">身に付けた技術を応用し、より難易度の高いレパートリー曲にも挑戦。フルートならではの表現力を高めます。クロマチック・スケール、テヌートとアクセント、ダイナミクス等、様々な技術を使ってソロやアンサンブルで楽しみながら演奏できるようにクラシックからポピュラーまで幅広いジャンルから表現していきます。</p>
						</section>
					</div>
				</div>
			</div>
			...
			<div class="cols gutter-40">
				<div class="col-12 view view-slideup">
					...
					<section class="mt50 sm-mt40 view view-slideup">
						<h3 class="ribbon-blue -lightgray">フルートセット</h3>
						<div class="mt30 bgc-white p50 md-p30 bdrs15">
							<div class="cols nega gutter-50 gutter-md-30 ai-c jc-c">
								<div class="col-7 col-sm-12">
									<p class="fz120 md-fz110 d-ib bb-black pb5">J.Michael FL-300S パピーセット</p>
									...
									<p class="mt20 c-red">定価　¥38,500</p>
									<table class="tbl-simple mt30">
										<tr>
											<th>調子</th>
											<td>：C</td>
										</tr>
								...
								<figure class="col-5 col-sm-9 ta-c sm-mt30"><img loading="lazy" src="<?php echo home_url(); ?>/img/flute/sec4-img1.jpg" width="421" height="96" class="img-rspsv" alt="フルート"></figure>
							</div>
						...
						<div class="mt30 bgc-white p50 md-p30 bdrs15">
							<div class="cols nega gutter-50 gutter-md-30 ai-c jc-c">
								<div class="col-7 col-sm-12">
									<p class="fz120 md-fz110 d-ib bb-black pb5">JUPITER JFL-700E パピーセット</p>
									<div class="d-f sm-d-b mt40 sm-mt25">
										<ul class="li-dots">
											<li>フルート本体</li>
											<li>クリーニングロッド</li>
									...
									<p class="mt20 c-red">定価　¥71,500</p>
									<table class="tbl-simple mt30">
										<tr>
											<th>調子</th>
											<td>：C</td>
								...
								<figure class="col-5 col-sm-9 ta-c sm-mt30"><img loading="lazy" src="<?php echo home_url(); ?>/img/flute/sec4-img2.jpg" width="405" height="88" class="img-rspsv" alt="フルート"></figure>
							</div>
							<p class="mt30">体験レッスン当日にご入会いただいた方は<span class="c-red">¥30,000(入会金¥17,800)</span>でご購入いただけます！</p>
						</div>
						<div id="sec4-sub3" class="mt30 bgc-white p50 md-p30 bdrs15">
							<div class="cols nega gutter-50 gutter-md-30 ai-c jc-c">
								<div class="col-7 col-sm-12">
									<p class="fz120 md-fz110 d-ib bb-black pb5">JUPITER JFL-700UD<span class="fz70">(キッズ用)</span> パピーセット</p>
									<div class="d-f sm-d-b mt40 sm-mt25">
										<ul class="li-dots">
											<li>フルート本体</li>
											<li>クリーニングロッド</li>
									...
									<p class="mt20 c-red">定価　¥85,800</p>
									<table class="tbl-simple mt30">
										<tr>
											<th>調子</th>
											<td>：C</td>
								...
								<figure class="col-5 col-sm-9 ta-c sm-mt30"><img loading="lazy" src="<?php echo home_url(); ?>/img/flute/sec4-img3.jpg" width="276" height="49" class="img-rspsv" alt="フルート"></figure>
							</div>
							<p class="mt30">体験レッスン当日にご入会いただいた方は<span class="c-red">¥39,000(入会金¥17,800)</span>でご購入いただけます！</p>
						</div>
					</section>
				</div>
			</div>
