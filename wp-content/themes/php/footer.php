...
<footer>
				...
				<div class="ta-c p50 sm-p30 ta-c cv-inner">
					...
					<div class="cols nega jc-c mt40 sm-mt30">
						<div class="col-5 col-sm-12">
							<a href="<?php echo home_url(); ?>/application" class="cv-btn d-b ta-c fw-b bgc-white c-blue bdrs-max">体験レッスン申し込み</a>
						</div>
						<div class="col-5 col-sm-12 sm-mt15">
							<a href="<?php echo home_url(); ?>/contact" class="cv-btn d-b ta-c fw-b bgc-white c-blue bdrs-max" target="_blank" rel="noopener">お問合わせフォーム</a>
						</div>
					</div>
	...
	<div class="copy bgc-blue ptb15 ta-c">
		<div class="d-f sm-d-b jc-c c-white ff-sofia fz90 sm-fz80 ta-c">
			<p>Copyright - <a href="<?php echo home_url(); ?>/" class="hov">puppy all rights reversed.</a></p>
			<p class="sm-d-n plr30">/</p>
			<p>Direction and design - <a href="https://walnuuut.com/" class="hov" target="_blank" rel="noopener">Walnut.</a></p>
		</div>
	</div>
</footer>
...
<?php if(is_home()){ ?>
<script src="<?php echo home_url(); ?>/js/jquery.bxslider.js" defer></script> 
<?php } ?>
