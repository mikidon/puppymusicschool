	...
	<div id="content">
		...
		<section id="sec2" class="bgc-lightblue mt250 sm-mt150 pb100 sm-pb70">
			<div class="cols-filld-full">
				<div class="col-9">
					<div class="d-f">
						<figure class="mr20 md-mr10 mt20 view view-slideup"><img loading="lazy" src="<?php echo home_url(); ?>/img/top/sec2-img1.jpg" width="261" height="230" class="img-rspsv view view-unique2" alt="コース案内"></figure>
						<figure class="mr20 md-mr10 view view-slideup"><img loading="lazy" src="<?php echo home_url(); ?>/img/top/sec2-img2.jpg" width="350" height="200" class="img-rspsv view view-unique2" alt="コース案内"></figure>
						<figure class="mt40 view view-slideup"><img loading="lazy" src="<?php echo home_url(); ?>/img/top/sec2-img3.jpg" width="390" height="230" class="img-rspsv view view-unique2" alt="コース案内"></figure>
					</div>
				</div>
			</div>
			<div class="cols">
