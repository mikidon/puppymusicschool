			...
			<div class="ptb20 sm-ptb30 cols-wide bg-dots">
				<div class="cols jc-c ai-c gutter-70 gutter-md-40">
					...
					<div class="col-6 col-sm-10 sm-mt40 view view-slideup">
						<figure class="view view-bounce"><img loading="lazy" src="<?php echo home_url(); ?>/img/bass/sec1-img1.png" width="446" height="437" class="img-rspsv" alt="ベース"></figure>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="cols gutter-30 gutter-sm-40">
				...
				<section class="col-6 col-sm-12 mt50 view view-slideup">
					<div class="bgc-white p40 md-p30 bdrs15 h-eq">
						...
						<p class="mt30">ベースの最も重要な要素は、”リズム感”にあると言っても過言ではないと思います。独学では習得の難しい、その”リズム感”や、ベースに必要なあらゆるテクニックや表現力を、先生と一緒に身につけましょう。</p>
					</div>
				</section>
				<section class="col-6 col-sm-12 mt50 sm-mt30 view view-slideup">
					<div class="bgc-white p40 md-p30 bdrs15 h-eq">
						<h3 class="fz130 sm-fz120 d-ib bb-black pb5">テクニカルコース</h3>
						<p class="mt30">憧れのベーシストたちのスーパーテクニックなど、より高度なベースプレイを身につけたい方のためのコースです。スーパーテクニックを身につけるには努力が必要ですが、間違った方法で努力していても身につけることはできません。正しいトレーニング方法で、確実にテクニックを身につけていきましょう。</p>
					</div>
				</section>
				<section class="col-6 col-sm-12 mt30 view view-slideup">
					<div class="bgc-white p40 md-p30 bdrs15 h-eq">
						<h3 class="fz130 sm-fz120 d-ib bb-black pb5">アレンジングコース</h3>
						<p class="mt30">バンドのベースアレンジはどうやって作ればいいのか。どうすればもっと良いア レンジを作ることができるのか。そんな悩みを持つベーシストのためのコースです。曲の土台をしっかり支えたり、躍動感を出したり、時には華やかなフレーズを入れたり…そんないろんなアレンジの作り方を、このコースで学びましょう。</p>
					</div>
				</section>
			</div>
		</section>
		...
		<section id="sec3" class="mtb100 sm-mtb70">
			...
			<div class="cols gutter-70 gutter-md-40 jc-fe">
				<div class="col-4 col-sm-6 sm-mr20 mt-80 sm-mt-60 z2 view view-slideup">
					<figure class="view view-bounce"><img loading="lazy" src="<?php echo home_url(); ?>/img/bass/sec3-img1.jpg" width="314" height="290" class="img-rspsv" alt="レッスン内容例"></figure>
				</div>
				<div class="col-9 col-sm-12 return-1 return-sm-0 mt50 sm-mt-20 z1 view view-slideup">
					<div class="bg-dots bd-blue ptb60 pl80 pr60 sm-ptb40 sm-pl30 sm-pr30 bdrs15">
						<section>
							...
							<p class="mt25">ゆっくりと楽しみながら持ち方、基本的な奏法、右手の指運び 、様々なリズムなどを演奏テクニックとともに身につけベースを基礎から学びます。</p>
						</section>
						<section class="mt30">
							<h3 class="c-white ff-sofia bgc-blue d-ib bdrs5 ptb5 plr20">STEP 02</h3>
							<p class="mt25">様々なスタイルのベースラインについてその構造を理解し、自分自身でベースラインやフレーズを作れる技術と知識を養います。</p>
						</section>
						<section class="mt30">
							<h3 class="c-white ff-sofia bgc-blue d-ib bdrs5 ptb5 plr20">STEP 03</h3>
							<p class="mt25">ベースの表現に必要な技術、グルーヴ、リズム、知識を完璧に身につけアドリブに挑戦し、ベーシストとしての個性の確立を目指します。</p>
						</section>
					</div>
				</div>
			</div>
			...
			<div class="cols gutter-40">
				<div class="col-12 view view-slideup">
					...
					<section class="mt50 sm-mt40 view view-slideup">
						<h3 class="ribbon-blue -lightgray">エレキベースセット</h3>
						<div class="mt30 bgc-white p50 md-p30 bdrs15">
							<div class="cols nega gutter-50 gutter-md-30 ai-c jc-c">
								<div class="col-7 col-sm-12">
									<p class="fz120 md-fz110 d-ib bb-black pb5 sm-d-n">KYORITSU CORPORATION エレキベース</p><br>
									<p class="fz120 md-fz110 bb-black pb5 d-n sm-d-ib">KYORITSU CORPORATION</p><br class="d-n sm-d-b">
									<p class="fz120 md-fz110 bb-black pb5 d-n sm-d-ib sm-mt10">エレキベース</p><br class="d-n sm-d-b">
