var googleSpreadSheetConfig = {
	name: 'mfpdata', // シートの名前
	id: '1O7KAGZ2q1xovZsHuBPwZoDI6aLbHtDQtZ4JDYazoCBI', // 共有可能なリンクのid=のあとの文字列
	action: 'https://script.google.com/macros/s/AKfycbw9EJOFaUqutfwSTrhrgrQy3QbODtilcthnFnpBK8Ta3xkNLAZV/exec', // 現在のウェブアプリケーションのURL
	mailformpro: 'contact/mailformpro/mailformpro.cgi?module=thanks&callback=googleSpreadSheetConnect.callback' // メールフォームプロのURL
};
